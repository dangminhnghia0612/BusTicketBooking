...
namespace BusTicketBooking.API.Data;
...
public partial class QLBanvexeDbContext : DbContext
{
    ...
    public virtual DbSet<Tinhtrangkhachhang> Tinhtrangkhachhang { get; set; }
...
//        => optionsBuilder.UseSqlServer("Data Source=MinhNghia;Initial Catalog=QLBanVeXe;Persist Security Info=True;User ID=sa;Password=123456;Trust Server Certificate=True");
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        modelBuilder.Entity<Apdungkhuyenmai>(entity =>
        {
            ...
            entity.HasIndex(e => e.MaDatve, "Datve_ApdungKM_FK");

            entity.HasIndex(e => e.MaKhuyenmai, "Khuyenmai_ApdungKM_FK");
        ...
        modelBuilder.Entity<Bieungu>(entity =>
        {
            ...
            entity.HasIndex(e => e.MaQuantrivien, "Quantrivien_Bieungu_FK");
        ...
        modelBuilder.Entity<Datve>(entity =>
        {
            ...
            entity.HasIndex(e => e.MaThanhtoan, "Datve_Thanhtoan_FK");

            entity.HasIndex(e => e.MaHuydatve, "Huydatve_Datve_FK");
            ...
            entity.HasOne(d => d.MaHuydatveNavigation).WithMany(p => p.Datve)
                .HasForeignKey(d => d.MaHuydatve)
                .HasConstraintName("FK_Datve_Huydatve");

            entity.HasOne(d => d.MaKhachhangNavigation).WithMany(p => p.Datve)
                .HasForeignKey(d => d.MaKhachhang)
                .HasConstraintName("FK_Datve_Khachhang");

            entity.HasOne(d => d.MaThanhtoanNavigation).WithMany(p => p.Datve)
        ...
        modelBuilder.Entity<Huydatve>(entity =>
        {
            ...
            entity.HasIndex(e => e.MaChinhsach, "Huydatve_Chinhsach_FK");

            entity.HasIndex(e => e.MaLydo, "Huydatve_Lydo_FK");

            entity.HasIndex(e => e.MaQuantrivien, "Quantrivien_Huydatve_FK");
        ...
        modelBuilder.Entity<Khachhang>(entity =>
        {
            ...
            entity.HasIndex(e => e.MaTinhtrang, "Tinhtrang_Khachhang_FK");
            ...
            entity.HasOne(d => d.MaTinhtrangNavigation).WithMany(p => p.Khachhang)
                .HasForeignKey(d => d.MaTinhtrang)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK_TinhTrangKhachHang");
        ...
        modelBuilder.Entity<Khuyenmai>(entity =>
        {
            ...
            entity.HasIndex(e => e.MaLoaikhuyenmai, "Khuyenmai_LoaiKM_FK");

            entity.HasIndex(e => e.MaQuantrivien, "Nguoitao_FK");
        ...
        modelBuilder.Entity<Thanhtoan>(entity =>
        {
            ...
            entity.HasOne(d => d.MaPhuongthucNavigation).WithMany(p => p.Thanhtoan)
        ...
        modelBuilder.Entity<Thongtinnhaxe>(entity =>
        {
            ...
            entity.HasIndex(e => e.MaQuantrivien, "Quantrivien_Thongtinnhaxe_FK");
        ...
        modelBuilder.Entity<Tinhtrangkhachhang>(entity =>
        {
        ...
        modelBuilder.Entity<Tintuc>(entity =>
        {
            ...
            entity.HasIndex(e => e.MaQuantrivien, "Quantrivien_Tintuc_FK");
        ...
        {
            entity.HasKey(e => e.MaTuyenxe).HasName("PK_ROUTES");

            entity.HasIndex(e => e.MaDiemden, "Diemden_FK");

            entity.HasIndex(e => e.MaDiemdi, "Diemdi_FK");

            entity.Property(e => e.MaTuyenxe).HasColumnName("Ma_Tuyenxe");
            entity.Property(e => e.Giave).HasColumnType("decimal(18, 0)");
            entity.Property(e => e.Khoangcach).HasColumnType("decimal(18, 0)");
            entity.Property(e => e.MaDiemden).HasColumnName("Ma_Diemden");
            entity.Property(e => e.MaDiemdi).HasColumnName("Ma_Diemdi");

            entity.HasOne(d => d.MaDiemdenNavigation).WithMany(p => p.TuyenxeMaDiemdenNavigation)
                .HasForeignKey(d => d.MaDiemden)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK_Tuyenxe_Diemden");

            entity.HasOne(d => d.MaDiemdiNavigation).WithMany(p => p.TuyenxeMaDiemdiNavigation)
                .HasForeignKey(d => d.MaDiemdi)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK_Tuyenxe_Diemdi");
        });
