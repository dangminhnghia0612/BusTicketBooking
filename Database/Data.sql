...
IF exists (SELECT * FROM Chinhsach)					DBCC CHECKIDENT (Chinhsach, RESEED, 0)
...
IF exists (SELECT * FROM Thanhtoan)					DBCC CHECKIDENT (Thanhtoan, RESEED, 0)
...
IF exists (SELECT * FROM Tinhtrangkhachhang)		DBCC CHECKIDENT (Tinhtrangkhachhang, RESEED, 0)
...
INSERT INTO Tinhtrangkhachhang(Ten) VALUES
(N'Chưa kích hoạt'),  
(N'Đã kích hoạt'),  
(N'Khóa tài khoản');  
...
INSERT INTO Xe (Ma_Loaixe, Bienso, Ten) VALUES (4, '51B-12345', N'Phương Trang FT1');
INSERT INTO Xe (Ma_Loaixe, Bienso, Ten) VALUES(4, '51B-67890', N'Phương Trang FT2');
INSERT INTO Xe (Ma_Loaixe, Bienso, Ten) VALUES(4, '51B-54321', N'Thành Bưởi TB1');
-- Xe ghế ngồi 34 chỗ
INSERT INTO Xe (Ma_Loaixe, Bienso, Ten) VALUES(3, '51G-11111', N'Hoàng Long HL1');
INSERT INTO Xe (Ma_Loaixe, Bienso, Ten) VALUES(3, '51G-22222', N'Hoàng Long HL2');
INSERT INTO Xe (Ma_Loaixe, Bienso, Ten) VALUES(3, '51G-33333', N'Mai Linh ML1');
-- Xe giường phòng 22 chỗ
INSERT INTO Xe (Ma_Loaixe, Bienso, Ten) VALUES (2, '51L-66666', N'Limousine Saigon 1');
INSERT INTO Xe (Ma_Loaixe, Bienso, Ten) VALUES(2, '51L-77777', N'Limousine Saigon 2');
-- Xe giường nằm đôi 22 chỗ
INSERT INTO Xe (Ma_Loaixe, Bienso, Ten) VALUES (1, '51D-88888', N'Đôi Phương Trang 1');
INSERT INTO Xe (Ma_Loaixe, Bienso, Ten) VALUES (1, '51D-99999', N'Đôi Thành Bưởi 1');
...
SELECT * FROM Huydatve
SELECT * FROM Lydohuydatve
SELECT * FROM Chinhsach
SELECT * FROM Khachhang
SELECT * FROM Tinhtrangkhachhang
SELECT * FROM Bieungu
SELECT * FROM Thongtinnhaxe
SELECT * FROM Tintuc
